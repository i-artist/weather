...
const weatherLayerGroups: WeatherLayerGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "冰点高度", id: "freezing", img: "/deg0.jpg" },
    ],
  },
  {
    title: "云量、航空",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "风浪", id: "windWaves", img: "/wwaves.jpg" },
      { name: "海流", id: "currents", img: "/currents.jpg" },
      { name: "潮汐流", id: "tide", img: "/currentsTide.jpg" },
    ],
  },
  {
    title: "空气质量",
    items: [
      { name: "一氧化碳浓度", id: "co", img: "/cosc.jpg" },
      { name: "沙尘质量", id: "dust", img: "/dustsm.jpg" },
      { name: "二氧化硫质量", id: "so2", img: "/tcso2.jpg" },
      { name: "二氧化氮", id: "no2", img: "/no2.jpg" },
      { name: "PM2.5", id: "pm2p5", img: "/pm2p5.jpg" },
      { name: "气溶胶", id: "aod", img: "/aod550.jpg" },
      { name: "臭氧层", id: "ozone", img: "/gtco3.jpg" },
      { name: "地表臭氧", id: "sfcOzone", img: "/go3.jpg" },
    ],
  },
  {
    title: "其他",
    items: [
      ...
      { name: "热气流", id: "thermals", img: "/heatmaps.jpg" },
            ...
            <div key={group.title} className="weather-drawer-section">
              ...
              <div className="weather-drawer-grid">
                {group.items.map((item) => (
                  <div
                    key={item.id}
                    className={`weather-drawer-card ${
                      activeId === item.id ? "active" : ""
                    }`}
                    onClick={() => handleItemClick(item.id)}
                  >
                    <div
                      className={`weather-drawer-card-image ${
                        item.img ? "has-image" : "no-image"
                      }`}
                      style={
